<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Situation.aspx.cs" Inherits="Situation" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="Ctopleft"></div>			
		...
		<!--<h3>TESTIMONIALS</h3>  -->
		<ul>
		<a href="#" target="_self"><li id="news" align="left">公司简介</li></a>
		<a href="#" target="_self">
		<li id="news" align="left">总经理的话</li></a>
		<a href="#" target="_self">
		<li id="news" align="left">企业文化</li></a>
		<a href="#" target="_self">
		<li id="news" align="left">公司结构</li></a>
        <a href="#" target="_self">
        <li id="news" align="left">公司待遇</li></a>
   </ul>
</asp:Content>
   ...
   <h3><font style="font-family:'微软雅黑'; font-size:16px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;公司简介</font></h3>
				<div id="news">
                     <table width="618" border="0">
                          <tr>
                            <td width="26">&nbsp;</td>
                         <td width="195" align="center" valign="middle"><img src="images/building.jpg" width="197" height="154" /></td>
                            <td width="253" valign="middle"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;云南希普防雷工程有限公司成立于1997年，是云南省最早成立的专业防雷公司。公司秉承严谨务实的作风，多年来专心做好服务云南省各类型的防雷工程，创造了综合防雷工程的体系，按照“系统、全面、综合的原则”进行设计施工。为客户创造一个更加安全的防雷环境。是云南省完成大型综合防雷工程最多的公司。</p></td>
                            <td width="60">&nbsp;</td>                            
                            <td width="62">&nbsp;</td>
                       </tr>
                          <tr>
